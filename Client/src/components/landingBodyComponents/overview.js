                ...
                <div>
                    ...
                    <Container fluid style={{ marginTop: '3vh' }}>
                        ...
                        <div className="benefits-div">
                            <h2>Benefits</h2>
                            <p>
                                Rental Vired gives you access to cars 24/7 without the hassle of owning one.
                                You can rent a car from just Rs400 an hour, with fuel, insurance and Roadside assistance included.
                            </p>
                            <Row>
                                <Col>
                    ...
                    <div className="find-nearest-car-div">
                        <h2>Find your nearest Rental Vired gives you access to cars 24/7 without the hassle of owning one. Garage</h2>
                        <p>Our cars are spread all over Banglore. There's probably one near you</p>
                        <div>
